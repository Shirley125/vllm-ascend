...
public class POJO implements Serializable {
	...
	private int ___key_id;
	
	public int getId() { return ___key_id; }
	public void setId(int id) { this.___key_id = id; }
	...
	protected String TableName() {
		if(__this_table_name == null)
			__this_table_name = "nap_" + Inflector.getInstance().tableize(getClass());
	 ...
	 * @param obj_id
	 */
	protected void Evict(int obj_id) {
	...
	public <T extends POJO> T Get(int id) {
		if(id <= 0) return null;
	...
	public List<? extends POJO> BatchGet(List<Integer> ids) {
	 ...
	 * @return 返回插入对象的主键
	 */
	private int _InsertObject(POJO obj) {		
