...
public class ResourceTool {
	...
	public String error(String key){
		return ResourceUtils.getStringForLocale(_getLocale(), "error", key);
	}
	
	public String error(String key, List<Object> args){
		return ResourceUtils.getStringForLocale(_getLocale(), "error", key, args.toArray(new Object[args.size()]));
	}

	/**
	 * 读取资源文件 ui.properties 中对应键为key的字符串值
	 * @param key
	 * @return
	 */
	public String ui(String key){
		return ResourceUtils.getStringForLocale(_getLocale(), "ui", key);
	}
	
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public String ui(String key, List args){
		return ResourceUtils.getStringForLocale(_getLocale(), "ui", key, args.toArray(new Object[args.size()]));
	}
